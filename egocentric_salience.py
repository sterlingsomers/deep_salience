...
def handle_observation(observation):
    ...
    result_factors = ['turn', 'altitude_change', 'diagonal_right_turn', 'right_turn', 'ascending', 'drop_action']
...
reset_actr()
start = time.time()
handle_observation(['isa','observation','current_altitude',3,'view_left',4,
                    'view_diagonal_left',4,
                    'view_center',1,
                    'view_diagonal_right',2,
                    'view_right',2])
end = time.time()
